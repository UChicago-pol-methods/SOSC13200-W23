...
\begin{itemize}
\item Google! \pause
\item Ask on our course StackOverflow team: \url{https://stackoverflowteams.com/c/sosc13200-w23-2} \pause {[}I'll send invites shortly{]}  \pause
...
\begin{itemize}
\item \url{https://github.com/UChicago-pol-methods/SOSC13200-W23}\pause
